...
if(!needsMerge){Oneline.objects.push(obj);}}; Oneline.once=function(event_type,message){
 var m={};var innerMessage={};var messageKeys=Object.keys(message);innerMessage['type']=eventType;innerMessage['data']={};for(var i in messageKeys){innerMessage['data'][messageKeys[i]]=message[messageKeys[i]];}
